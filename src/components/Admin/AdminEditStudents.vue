<template>
    <div class="student-container">
      ...
      <form @submit.prevent="createStudent" class="new-student-form">
        <div>
          ...
          <input type="text" id="vorname" v-model="newStudentVorname" required />
        </div>
        <div>
          <label for="nachname">Nachname:</label>
          <input type="text" id="nachname" v-model="newStudentNachname" required />
        </div>
        <div>
          <label for="schuelerkennzahl">Schülerkennzahl:</label>
          <input type="text" id="schuelerkennzahl" v-model="newStudentSchuelerkennzahl" required />
        </div>
        <div>
      ...
      <table class="styled-table">
        ...
        <tbody>
          <tr v-for="student in filteredStudents" :key="student.id">
            ...
            <td>
              <button class="btn waves-effect red" @click="deleteStudent(student.schuelerkennzahl)">Löschen</button>
            </td>
          </tr>
        </tbody>
      </table>
  ...
  export default defineComponent({
    ...
    setup() {
      ...
      /**
       * GET /api/admin/getKVStudents
       * Lädt alle Schüler (id, vorname, nachname, schuelerkennzahl, classroom)
       */
       ...
       * Falls du diesen Endpoint hast, um alle Klassen zu laden
       */
      async function fetchAllClassrooms() {
        try {
          const response = await axios.get("/api/admin/classrooms");
      ...
      async function createStudent() {
        ...
        try {
          ...
          const response = await axios.post("/api/admin/newStudent",
            requestBody,
            {
              headers: {
      ...
      async function deleteStudent(studentSchuelerkennzahl: string) {
        try {
          ...
          await axios.delete(`/api/admin/deleteStudent/${studentSchuelerkennzahl}`, {
      ...
      const filteredStudents = computed(() => {
        ...
        return students.value.filter(student => {
          ...
          const klassenzimmer = student.classroom ? student.classroom.toLowerCase() : "";
